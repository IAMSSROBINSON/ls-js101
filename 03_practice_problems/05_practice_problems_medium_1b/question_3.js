...
The expression: number % divisor === 0; checks whether the given divisor is a factor of the number since a factor of a number is any whole number that can be multiplied by itself or another number with no remainder.
