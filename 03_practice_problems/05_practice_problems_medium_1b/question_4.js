...
console.log(addToRollingBuffer1(array, 4, "a"));
console.log(addToRollingBuffer1(array, 4, "b"));
console.log(addToRollingBuffer1(array, 4, "c"));
console.log(addToRollingBuffer1(array, 4, "d"));
console.log(addToRollingBuffer1(array, 4, "e"));
...
.concat() returns a new array and does not mutate the caller.
